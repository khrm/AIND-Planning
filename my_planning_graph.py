...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            for state_node in self.s_levels[level]:
                if state_node in a_node.prenodes:
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return  (set(node_a1.action.effect_add) & set(node_a2.action.effect_rem))\
            or (set(node_a1.action.effect_rem) & set(node_a2.action.effect_add))
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        return (set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos))\
            or (set(node_a2.action.effect_rem) & set(node_a1.action.precond_pos))\
            or (set(node_a1.action.effect_add) & set(node_a2.action.precond_neg))\
            or (set(node_a2.action.effect_add) & set(node_a1.action.precond_neg))
